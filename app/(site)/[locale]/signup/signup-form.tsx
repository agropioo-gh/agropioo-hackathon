...
<div>
                  ...
                  <div className="relative mt-2">
                    ...
                    <button
                      ...
                      className="absolute right-2 top-1/2 -translate-y-1/2 flex h-12 w-12 cursor-pointer items-center justify-center rounded-lg text-agro-slate transition-colors"
